...
export function ThemeToggle() {
  ...
  return (
    <Button
      ...
      size="icon"
      onClick={toggleTheme}
      className="relative h-9 w-9 rounded-md border border-orange-200 dark:border-orange-900 hover:bg-orange-50 dark:hover:bg-orange-950/50 hover:border-orange-400 dark:hover:border-orange-600 transition-all duration-200"
    >
